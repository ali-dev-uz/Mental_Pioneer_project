...
class CryptoPayments:
    ...
    def __init__(self):
        self.publicKey = "1c4c1e9a7baf18b86a0396bb853a0884367a1518cf31caedf352202d3876b4e4"
        self.privateKey = "e36A82C9e65a6e81D0FDcc1614e7FC39F710C1Ef3F732E1f11b10ec721e75904"
        self.ipn_url = "https://t.me/Direction_Droid_bot"
        self.format = 'json'
        self.version = 1
    ...
    def Request(self, request_method, **params):
        ...
        try:
            ...
            response_body_decoded.update(response_body_decoded[
                                             'result'])  # clean up dictionary, flatten "result" key:value pairs to parent dictionary
